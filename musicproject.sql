...
/*4. Which city has the best customers? We would 
like to throw a promotional Music Festival in the city we made the most money.
...
SELECT TOP 1 customer.customer_id,first_name,last_name,
...
/*1. Write query to return the email, first name, last name, & Genre of
...
Write a querythat returns the Artist name and total track count of the top 10 rock bands*/
